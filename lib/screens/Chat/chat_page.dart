    ...
    body: SafeArea(
      child: Column(
        children: [
              ...
              builder: (context, messageSnapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // We'll need to get chatData here for message building
          ...
          // Action buttons area with its own StreamBuilder
          StreamBuilder<ChatModel?>(
            stream: _chatService.getChatStream(widget.chatId),
            builder: (context, chatSnapshot) {
              if (!chatSnapshot.hasData) return const SizedBox.shrink();
              final ChatModel chatData = chatSnapshot.data!;
              return _buildActionButtonsArea(chatData);
            },
          ),
                      ...
                      onPressed: _isConfirmingDeal
                          ...
                          : () async {
                              ...
                              try {
                                ...
                                bool locked = await ChatService.lockDeal(
                                ...
                                if (locked) {
                                  ...
                                  // Assume orderId returned by API or generate locally
